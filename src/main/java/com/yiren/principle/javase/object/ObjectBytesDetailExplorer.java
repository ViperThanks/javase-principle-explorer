 ...
 */
@Slf4j
public class ObjectBytesDetailExplorer implements ExplorerTestable {
   ...
   */
  public void explore() {
    System.out.println(ClassLayout.parseInstance(emptyUser).toPrintable());
    System.out.println("\n=======happy everyday=======\n");
    System.out.println(ClassLayout.parseInstance(testUser).toPrintable());
  }
